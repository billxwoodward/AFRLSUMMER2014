...
public class ClientConnectPanel extends JPanel {
	...
	public static class MyTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int row, int col) {
        	...
        	switch (col)
        	{
        	case 0: return ClientComm.getIcon();
        	case 1: return ClientComm.address;
        	case 2: return ClientComm.port;
        	case 3: return ClientComm.isRunning();
        ...
        public boolean isCellEditable(int row, int col) {
        	...
        	case 1: return !ClientComm.isRunning();
        	case 2: return !ClientComm.isRunning();
        	case 3: return true;
        	}
        ...
        public void setValueAt(Object value, int row, int col) {
	        if (1 == col)
	        	ClientComm.address = (String)value;
	        else if (2 == col)
	        	ClientComm.port = (Integer) value;
	        else if (3 == col) {
	        	if (ClientComm.isRunning())
	        		ClientComm.close();
	        	else
	        		ClientComm.connect();
	        	clientStateUpdated();
        ...
        public static void clientStateUpdated()
        {
