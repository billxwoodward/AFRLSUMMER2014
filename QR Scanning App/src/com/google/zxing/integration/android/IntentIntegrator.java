...
public class IntentIntegrator {
	...
	public IntentIntegrator(Activity activity) {
		...
		moreExtras = new HashMap<String, Object>(6);
		moreExtras.put("RESULT_DISPLAY_DURATION_MS", 0L);
		moreExtras.put("ENCODE_SHOW_CONTENTS", false);
		moreExtras.put("CHARACTER_SET", "ISO-8859-15");
		moreExtras.put("SCAN_FORMATS", "QR_CODE");

		moreExtras.put("SCAN_WIDTH", 400);
		moreExtras.put("SCAN_HEIGHT", 400);
	}
	...
	public final AlertDialog initiateScan() {
		...
		System.out.println("startin activity");
